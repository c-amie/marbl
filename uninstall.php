...
* Uninstall script
*
* Uninstall script for Marbl for Amazon.
*
* @since 0.9.3
*
* @package WordPress
...
if (!defined( 'WP_UNINSTALL_PLUGIN' )) {
	...
	$arrOptions = ['marbl_general_link_open_new_window', 'marbl_general_link_show_flags',
				   'marbl_general_link_link_nofollow', 'marbl_general_include_default_css',
				   'marbl_general_custom_resources_path', 'marbl_general_version'
				   
				   'marbl_amazon_enabled', 'marbl_amazon_link_open_new_window',
				   'marbl_amazon_link_show_flags', 'marbl_amazon_include_default_css',
				   'marbl_amazon_link_link_nofollow', 'marbl_amazon_show_disclaimer',
				   'marbl_amazon_disclaimer_position', 'marbl_amazon_disclaimer',
				   
				   'marbl_ebay_enabled', 'marbl_ebay_partner_id',
				   'marbl_ebay_default_campaign_id', 'marbl_ebay_show_disclaimer',
				   'marbl_ebay_disclaimer_position', 'marbl_ebay_disclaimer'];
